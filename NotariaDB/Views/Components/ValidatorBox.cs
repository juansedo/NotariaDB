...
namespace NotariaDB.Views.Components
{
    class ValidatorBox : GroupBox
    {
        ...
        public ValidatorBox(string name, int tabIndex, System.Drawing.Point location) : base()
        {
            _name = name;
            ...
            this.Location = location; //new System.Drawing.Point(494, 45);
            this.Name = "gb" + name;
